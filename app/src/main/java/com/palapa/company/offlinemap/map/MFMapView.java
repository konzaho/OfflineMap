package com.palapa.company.offlinemap.map;

/**
 * Created by Enzaho on 25-Jun-15.
 */
...
import com.palapa.company.offlinemap.map.overlays.MyLocationNewOverlay;
import com.palapa.company.offlinemap.map.overlays.RotationGestureOverlay;
    ...
    public void setCurrentAsCenter()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                this.getController().setCenter(new GeoPoint(-6.9430489, 107.6293971)); // Bandung
                this.getController().setZoom(15);
            }
            try
            {
